...
class MeasurementStatsForJetty extends Widget implements HasForms // Implement the contract
{
    ...
    protected static string $view = 'filament.widgets.measurement-stats-for-jetty';
